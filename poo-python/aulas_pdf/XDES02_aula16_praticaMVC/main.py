...
class LimitePrincipal():
    def __init__(self, root, controle):
        ...
        self.estudanteMenu.add_command(label="Cadastrar", command=self.controle.insereArtista)
        self.estudanteMenu.add_command(label="Consultar", command=self.controle.mostraArtista)
